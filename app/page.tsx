      ...
      <header className="border-b shadow-sm bg-white">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-sans font-bold text-royal-500">PaperMind</span>
          </div>
            ...
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-white/80 md:text-xl">
                  PaperMind helps you read, understand, and connect research papers with AI-powered insights and an
          ...
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] mx-auto text-white/80 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join thousands of researchers who are using PaperMind to enhance their understanding and connections.
              </p>
            </div>
